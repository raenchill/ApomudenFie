          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-6">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="text-green-700 hover:text-green-900 font-medium text-sm transition-colors"
              >
                Resend email
              </button>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-green-600 text-white py-3 rounded-lg font-semibold hover:bg-green-700 disabled:bg-green-400 disabled:cursor-not-allowed transition-all duration-200 transform hover:scale-105 disabled:transform-none flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
