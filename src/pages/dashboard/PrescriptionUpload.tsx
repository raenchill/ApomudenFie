      ...
      <main className="max-w-6xl mx-auto py-8 px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            {file && (
              <button
                ...
                disabled={scanning}
                className="w-full mt-6 px-6 py-4 bg-gradient-to-r from-blue-600 to-green-600 text-white rounded-xl font-bold text-lg hover:from-blue-700 hover:to-green-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
              >
                {scanning ? (
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            {scanning && (
              <div className="text-center py-12">
                <div className="w-20 h-20 mx-auto bg-gradient-to-r from-blue-100 to-green-100 rounded-full flex items-center justify-center mb-6 relative">
                  <div className="w-10 h-10 border-3 border-blue-600 border-t-transparent rounded-full animate-spin"></div>
                  <div className="absolute inset-0 border-3 border-green-600 border-b-transparent rounded-full animate-spin" style={{animationDelay: '0.5s'}}></div>
            ...
            {searchingDatabase && !scanning && !isSeedingDatabase && (
              <div className="text-center py-12">
                ...
                <p className="text-green-600 font-medium text-lg mb-2">Searching database...</p>
              ...
              <div className="space-y-6">
                ...
                {scannedDrugs.length > 0 && (
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h4 className="text-sm font-semibold text-green-800">AI Analysis Successful!</h4>
                    </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                  ...
                  <div className="flex items-center justify-between text-sm mt-1">
                    ...
                    <span className="font-semibold text-green-800">{availableDrugs.length}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm mt-1">
