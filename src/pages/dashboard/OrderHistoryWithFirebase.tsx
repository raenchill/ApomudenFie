    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto py-16 px-4">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-3xl font-bold text-violet-700">Order History</h1>
          {orders.length === 0 && (
            <button
              onClick={handleCreateSampleOrders}
              disabled={creatingSamples}
              className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-violet-600 text-white px-4 py-2 rounded-lg hover:from-blue-700 hover:to-violet-700 transition-all duration-300 disabled:opacity-50"
            >
              {creatingSamples ? (
                <>
            ...
            {orders.map(order => (
              <div key={order.id} className="bg-white rounded-lg shadow-md p-6 animate-fade-in-up">
                ...
                <div className="mb-3">
                  <div className="flex flex-wrap gap-4 items-center">
                    ...
                    {order.items.map((item, idx) => (
                      <span key={idx} className="inline-flex items-center gap-2 bg-violet-50 text-violet-800 px-3 py-1 rounded-full text-xs">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <span className="text-lg font-bold text-violet-700">Total: ₵{order.totalAmount.toFixed(2)}</span>
                  <button 
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  <Dialog.Title as="h3" className="text-2xl font-bold text-violet-700 mb-2 flex items-center gap-2">
                    <ShoppingBag className="h-6 w-6 text-violet-700" /> Order Details
                  </Dialog.Title>
                  {selectedOrder && (
                    <div>
                      ...
                      <div className="mb-4">
                        <h4 className="text-lg font-semibold text-violet-700 mb-2">Items</h4>
                      ...
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                        <span className="text-lg font-bold text-violet-700">Total: ₵{selectedOrder.totalAmount.toFixed(2)}</span>
                      ...
                      <div className="mt-4 p-4 bg-violet-50 rounded-lg text-violet-800 text-sm flex items-center gap-2">
                  ...
                  <div className="mt-6 flex justify-end">
                    <button
                      type="button"
                      className="inline-flex justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2"
                      onClick={closeModal}
                    >
                      Close
                    </button>
