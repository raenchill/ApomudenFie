    ...
    const loadHealthInsights = async () => {
      try {
        ...
        setHealthStats(stats.length > 0 ? stats : [
          ...
          { label: 'Health Score', value: '85%', icon: 'heart-pulse', color: 'violet', trend: 'up' },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-3xl font-bold mb-6 text-violet-700">Health Insights</h1>
        ...
        {loading && (
          <div className="text-center py-12">
            ...
            <p className="text-violet-600 font-medium text-lg mb-2">Loading your health insights...</p>
          ...
          {(healthStats.length > 0 || chartData.length > 0) && (
            ...
            <div className="mb-6 p-4 bg-violet-50 border border-violet-200 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-violet-800">Health Insights Loaded Successfully</h4>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-10 animate-fade-in">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-semibold text-violet-700">Orders This Week</span>
          </div>
        ...
        {/* Tips */}
        <div className="bg-violet-50 rounded-xl shadow-md p-6 mb-10 animate-fade-in-up">
          <div className="flex items-center gap-2 mb-3">
            <Sun className="h-5 w-5 text-yellow-500" />
            <span className="font-semibold text-violet-700">Ghana Health Tips</span>
          </div>
        ...
        {medicationAdherence.length > 0 && (
          <div className="bg-white rounded-xl shadow-md p-6 mb-10 animate-fade-in">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold text-violet-700">Medication Adherence</span>
            </div>
                ...
                <div key={idx} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                      medication.adherenceRate >= 90 ? 'bg-violet-100 text-violet-800' :
        ...
        <div className="bg-white rounded-xl shadow-md p-6 animate-fade-in">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="font-semibold text-violet-700">Recent Activity</span>
          </div>
              ...
              {recentActivities.map((activity, idx) => (
                <li key={idx} className="flex items-center justify-between">
                  ...
                  <span className={`text-sm ${
                    activity.status === 'completed' ? 'text-violet-700' :
