        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
          {riders.map(rider => (
            ...
            >
              ...
              <div className="absolute -top-4 right-4 bg-gradient-to-r from-green-400 to-blue-300 text-white text-xs font-bold px-4 py-1 rounded-full shadow-lg flex items-center gap-1 z-20 border-2 border-white">
        ...
        <div className="relative bg-white/70 backdrop-blur-lg rounded-3xl shadow-2xl p-10 flex flex-col items-center border-2 border-blue-200 transform scale-105 transition-all duration-300" style={{ boxShadow: '0 12px 40px 0 rgba(31, 38, 135, 0.22)', perspective: 800 }}>
          ...
          <div className="w-28 h-28 rounded-full bg-gradient-to-tr from-blue-400 via-green-300 to-teal-200 shadow-lg flex items-center justify-center mb-3 border-4 border-white/80">
            {selectedRider.image ? (
              ...
              <div className="w-24 h-24 rounded-full bg-gradient-to-r from-blue-500 to-green-500 flex items-center justify-center text-white font-bold text-2xl">
          ...
          {/* Floating vehicle badge */}
          <div className="absolute -top-4 right-8 bg-gradient-to-r from-green-400 to-blue-300 text-white text-sm font-bold px-6 py-2 rounded-full shadow-xl flex items-center gap-2 z-20 border-2 border-white">
